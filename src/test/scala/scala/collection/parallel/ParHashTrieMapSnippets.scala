...
trait ParHashTrieMapSnippets {
  ...
  def foldParallel(hs:HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = hs.toPar.fold((0,0))(sumPairs)
  ...
  def reduceParallel(hs: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = hs.toPar.reduce(sumPairs)
  ...
  def mapReduceParallel(hs: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = hs.toPar.mapReduce(_._1 + 1)(_ + _)
  ...
  def sumParallel(a: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = a.toPar.sum(customSumNum, s)
  ...
  def productParallel(a: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = a.toPar.product(customProdNum, s)
  ...
  def countSquareMod3Parallel(a: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = a.toPar.count{x => val el = x._1;  (el * el) % 3 == 0}


  def minParallel(a: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = a.toPar.min

  def maxParallel(a: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = a.toPar.max
  ...
  def findSinParallel(a: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = a.toPar.find(x => math.sin(x._1) == 2.0)

  def findParallel(a: HashMap[Int, Int], elem: Int)(implicit s: WorkstealingTreeScheduler) = a.toPar.find(x => x._1 == elem && x._2 == elem)

  def existsParallel(a: HashMap[Int, Int], elem: Int)(implicit s: WorkstealingTreeScheduler) = a.toPar.exists(x => x._1 == elem && x._2 == elem)

  def forallSmallerParallel(a: HashMap[Int, Int], elem: Int)(implicit s: WorkstealingTreeScheduler) = a.toPar.forall(x => x._1 < elem && x._2 < elem)
  ...
  def foreachParallel(a: HashMap[Int, Int])(implicit s: WorkstealingTreeScheduler) = {
    val ai = new java.util.concurrent.atomic.AtomicLong(0)
