...
object Arrays {
  ...
  class Ops[T](val array: Par[Array[T]]) extends AnyVal with Zippables.OpsLike[T, Par[Array[T]]] {
    ...
    override def aggregate[S](z: S)(combop: (S, S) => S)(seqop: (S, T) => S)(implicit ctx: WorkstealingTreeScheduler) = macro internal.ArraysMacros.aggregate[T, S]
    def accumulate[S](merger: Merger[T, S])(implicit ctx: WorkstealingTreeScheduler): S = macro internal.ArraysMacros.accumulate[T, S]
    override def foreach[U >: T](action: U => Unit)(implicit ctx: WorkstealingTreeScheduler): Unit = macro internal.ArraysMacros.foreach[T, U]
    override def mapReduce[R](mapper: T => R)(reducer: (R, R) => R)(implicit ctx: WorkstealingTreeScheduler): R = macro internal.ArraysMacros.mapReduce[T, T, R]
    override def reduce[U >: T](operator: (U, U) => U)(implicit ctx: WorkstealingTreeScheduler) = macro internal.ArraysMacros.reduce[T, U]
    override def fold[U >: T](z: => U)(op: (U, U) => U)(implicit ctx: WorkstealingTreeScheduler): U = macro internal.ArraysMacros.fold[T, U]
    override def sum[U >: T](implicit num: Numeric[U], ctx: WorkstealingTreeScheduler): U = macro internal.ArraysMacros.sum[T, U]
    override def product[U >: T](implicit num: Numeric[U], ctx: WorkstealingTreeScheduler): U = macro internal.ArraysMacros.product[T, U]
    override def min[U >: T](implicit ord: Ordering[U], ctx: WorkstealingTreeScheduler): U = macro internal.ArraysMacros.min[T, U]
    override def max[U >: T](implicit ord: Ordering[U], ctx: WorkstealingTreeScheduler): U = macro internal.ArraysMacros.max[T, U]
    override def find[U >: T](p: U => Boolean)(implicit ctx: WorkstealingTreeScheduler): Option[T] = macro internal.ArraysMacros.find[T, U]
    override def exists[U >: T](p: U => Boolean)(implicit ctx: WorkstealingTreeScheduler): Boolean = macro internal.ArraysMacros.exists[T, U]
    override def forall[U >: T](p: U => Boolean)(implicit ctx: WorkstealingTreeScheduler): Boolean = macro internal.ArraysMacros.forall[T, U]
    override def count[U >: T](p: U => Boolean)(implicit ctx: WorkstealingTreeScheduler): Int = macro internal.ArraysMacros.count[T, U]
    override def map[S, That](func: T => S)(implicit cmf: CanMergeFrom[Par[Array[T]], S, That], ctx: WorkstealingTreeScheduler) = macro internal.ArraysMacros.map[T, S, That]
    override def filter[That](pred: T => Boolean)(implicit cmf: CanMergeFrom[Par[Array[T]], T, That], ctx: WorkstealingTreeScheduler) = macro internal.ArraysMacros.filter[T, That]
    override def flatMap[S, That](func: T => TraversableOnce[S])(implicit cmf: CanMergeFrom[Par[Array[T]], S, That], ctx: WorkstealingTreeScheduler) = macro internal.ArraysMacros.flatMap[T, S, That]
    def seq = array
  }
  ...
  final class ArrayMerger[@specialized(Int, Long, Float, Double) T: ClassTag](
    ...
    private val ctx: WorkstealingTreeScheduler) extends Conc.BufferLike[T, Par[Array[T]], ArrayMerger[T]] with collection.par.Merger[T, Par[Array[T]]] {
